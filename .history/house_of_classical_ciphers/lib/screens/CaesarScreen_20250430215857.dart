...
class _CaesarPageState extends State<CaesarPage> {
  ...
  Future<void> runCaesar(String mode) async {
    ...
    if (mode == "crack") {
      arguments = ['E:/crypto project/house_of_classical_ciphers/python/Caesar.pypython/Caesar.py', mode, text];
    } else {
      arguments = ['E:/crypto project/house_of_classical_ciphers/python/Caesar.pypython/Caesar.py', mode, text, key];
    }
